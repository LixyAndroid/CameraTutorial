...
extern"C" {
    ...
    JNIEXPORT void JNICALL Java_com_example_cameratutorial_CameraViewActivity_initLoad(JNIEnv* env, jobject, jstring haarfilePath)
    {
    ...
    JNIEXPORT void JNICALL Java_com_example_cameratutorial_CameraViewActivity_faceDetect(JNIEnv*, jobject, jlong addrRgba)
    {
        int flag = 1000;
